...
void VL53L1XSensor::setup() {
    ...
    while (reg16(0x00E5).get() == 0x00) {
        if (this->timeout_us_ > 0 && ((uint32_t) (micros() - this->timeout_start_us_) > this->timeout_us_)) {
...
int8_t VL53L1XSensor::getRangeStatus() {
    ...
    RgSt = RgSt&0x1F;
    /**
    Same mapping as in ST library. See method ConvertStatusLite in:
    https://github.com/pololu/vl53l1x-st-api-arduino/blob/eb92015d0651e02a4bb3fe88c31f13b95a566829/vl53l1x-st-api/vl53l1_api.c#L1991
    **/
    switch (RgSt)
    {
    case VL53L1_DEVICEERROR_RANGECOMPLETE:
        RgSt = VL53L1_RANGESTATUS_RANGE_VALID;
        break;
    case VL53L1_DEVICEERROR_SIGMATHRESHOLDCHECK:
        RgSt = VL53L1_RANGESTATUS_SIGMA_FAIL;
        break;
    case VL53L1_DEVICEERROR_MSRCNOTARGET:
        RgSt = VL53L1_RANGESTATUS_SIGNAL_FAIL;
        break;
    case VL53L1_DEVICEERROR_MINCLIP:
        RgSt = VL53L1_RANGESTATUS_RANGE_VALID_MIN_RANGE_CLIPPED;
        break;
    case VL53L1_DEVICEERROR_RANGEPHASECHECK:
        RgSt = VL53L1_RANGESTATUS_OUTOFBOUNDS_FAIL;
        break;
    case VL53L1_DEVICEERROR_NOVHVVALUEFOUND:
        RgSt = VL53L1_RANGESTATUS_HARDWARE_FAIL;
        break;
    case VL53L1_DEVICEERROR_RANGECOMPLETE_NO_WRAP_CHECK:
        RgSt = VL53L1_RANGESTATUS_RANGE_VALID_NO_WRAP_CHECK_FAIL;
        break;
    case VL53L1_DEVICEERROR_PHASECONSISTENCY:
        RgSt = VL53L1_RANGESTATUS_WRAP_TARGET_FAIL;
        break;
    case VL53L1_DEVICEERROR_RANGEIGNORETHRESHOLD:
        RgSt = VL53L1_RANGESTATUS_XTALK_SIGNAL_FAIL;
        break;
    case VL53L1_DEVICEERROR_GPHSTREAMCOUNT0READY:
        RgSt = VL53L1_RANGESTATUS_SYNCRONISATION_INT;
      break;
    case VL53L1_DEVICEERROR_RANGECOMPLETE_MERGED_PULSE:
        RgSt = VL53L1_RANGESTATUS_RANGE_VALID_MERGED_PULSE;
        break;
    case VL53L1_DEVICEERROR_PREV_RANGE_NO_TARGETS:
        RgSt = VL53L1_RANGESTATUS_TARGET_PRESENT_LACK_OF_SIGNAL;
        break;
    case VL53L1_DEVICEERROR_USERROICLIP:
        RgSt = VL53L1_RANGESTATUS_MIN_RANGE_FAIL;
        break;
    default:
        RgSt = VL53L1_RANGESTATUS_NONE;
        break;
    }
    return RgSt;
}
